...
class Chroma2Klein(BASE):
    ...
    def clip_target(self, state_dict={}):
        result = {}
        pref = self.text_encoder_key_prefix[0]
        if "{}qwen.model.embed_tokens.weight".format(pref) in state_dict:
            result['qwen'] = 'text_encoder'
        elif "{}qwen.embed_tokens.weight".format(pref) in state_dict:
            result['qwen'] = 'text_encoder'
        elif any('qwen' in k and 'embed_tokens' in k for k in state_dict.keys()):
            result['qwen'] = 'text_encoder'
        return result


models = [Stable_Zero123, SD15_instructpix2pix, SD15, SD20, SD21UnclipL, SD21UnclipH, SDXL_instructpix2pix, SDXLRefiner, SDXL, SSD1B, KOALA_700M, KOALA_1B, Segmind_Vega, SD_X4Upscaler, Stable_Cascade_C, Stable_Cascade_B, SV3D_u, SV3D_p, SD3, StableAudio, AuraFlow, HunyuanDiT, HunyuanDiT1, Chroma2Klein, Flux, FluxSchnell]
