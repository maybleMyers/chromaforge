...
Download https://huggingface.co/lodestones/Chroma1-Radiance/blob/main/latest_x0_x32_proto.safetensors Put it in your stable diffusion subfolder. Use the radiance model in the chroma tab of the gui without a vae. It will be automatically detected. Use the same T5 you normally use.  
