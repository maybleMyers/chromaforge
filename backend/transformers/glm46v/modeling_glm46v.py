...
from transformers.utils import auto_docstring, can_return_tuple, is_torchdynamo_compiling
from transformers import AutoModel
from .configuration_glm46v import Glm46VConfig

# Handle TransformersKwargs which may not exist in older transformers
try:
