...
#   Deliberately signature-agnostic: img2img_function() grows new UI arguments regularly
#   (ref_edit_*, sigma_rescale_*, apg_*, fill_*, checkpoint_name, ...) and a wrapper that
#   restates them silently mis-binds every argument after the first new one.
