...
options_templates.update(options_section(('img2img', "img2img", "sd"), {
    ...
    "img2img_autosize": OptionInfo(True, "After loading into Img2img, automatically update Width and Height"),
...
options_templates.update(options_section(('optimizations', "Optimizations", "sd"), {
    ...
    "torch_compile": OptionInfo(False, "Torch compile").info("compile repeated transformer blocks with torch.compile (regional compile, lossless speedup after warmup); takes effect on next model load"),
    "torch_compile_mode": OptionInfo("default", "Torch compile mode", gr.Radio, {"choices": ["default", "max-autotune-no-cudagraphs", "max-autotune"]}).info("max-autotune modes compile slower but may run faster"),
