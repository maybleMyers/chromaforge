...
def forge_model_reload():
    ...
    try:
        sd_model = forge_loader(state_dict, additional_state_dicts=additional_state_dicts, preset=model_data.forge_loading_parameters.get('forge_preset', shared.opts.forge_preset))
