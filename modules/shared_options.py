...
options_templates.update(options_section(('optimizations', "Optimizations", "sd"), {
    ...
    "torch_compile_mode": OptionInfo("Disabled", "Torch Compile (Transformer)", gr.Dropdown, {"choices": ["Disabled", "reduce-overhead", "max-autotune", "default"]}).info("Compile the diffusion transformer for faster inference. First generation is slower due to compilation. Requires PyTorch 2.0+."),
}))
